...
class MultiBot:
    ...
    def create(self):
        ...
        if self.attributes.get("limit_pairs", False):
            ...
            self.logging.info(
                "Volume sorting and limiting symrank list to max active deals",
                True,
            )
            ...
            if self.tg_data["action"] == "START":
                ...
                if pair:
                    if pair in self.asyncState.multibot["pairs"]:
                        ...
                        # if limit_pairs == True, add trigger pair to pairs_volume list and sort
                        if (
                            self.attributes.get("limit_pairs", False)
